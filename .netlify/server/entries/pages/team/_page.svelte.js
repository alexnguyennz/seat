...
const TeamMember = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-1884w4h_START --><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@latest/tabler-icons.min.css"><!-- HEAD_svelte-1884w4h_END -->`, ""}
...
<div>
	...
	<div><div>
		...
		<div class="hr svelte-dojhlc"><button><i${add_attribute("id", `${data.slug}-arrow`, 0)} class="ti ti-arrow-down"></i></button></div></div>
</div>`;
});
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-1wk2rsm_START -->${$$result.title = `<title>Our team</title>`, ""}<meta name="description" content="Our team"><link rel="preload" as="image" href="/team/clint-schoultz.png"><link rel="preload" as="image" href="/team/bradley-alford.png"><link rel="preload" as="image" href="/team/jessica-armstrong.png"><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@latest/tabler-icons.min.css"><!-- HEAD_svelte-1wk2rsm_END -->`, ""}

<section class="space-y-5"><h1 class="page-heading">Our team</h1>

	<div class="members svelte-gs9904">${validate_component(TeamMember, "TeamMember").$$render($$result, { data: data[0] }, {}, {
    default: () => {
      return `<div class="member svelte-gs9904"><ul class="award svelte-gs9904"><li><i class="ti ti-award-filled"></i>
						<span>Masters of Business Administration - Innovation and Leadership</span></li>
					<li><i class="ti ti-award-filled"></i>
		...
		${validate_component(TeamMember, "TeamMember").$$render($$result, { data: data[1] }, {}, {
    default: () => {
      return `<div class="member space svelte-gs9904"><p class="svelte-gs9904">Brad has worked in the hospitality industry for 20+ years in various management roles.
		...
		${validate_component(TeamMember, "TeamMember").$$render($$result, { data: data[2] }, {}, {
    default: () => {
